...
Цель проекта: Создать высокотехнологичную систему рекомендаций, которая персонализирует предложение банковских продуктов для клиентов на основе анализа их поведения и данных.
